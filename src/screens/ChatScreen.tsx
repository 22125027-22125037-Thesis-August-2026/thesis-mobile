...
const INITIAL_MESSAGE: Message = {
  id: '1',
  text: 'Chào bạn, hôm nay bạn thấy thế nào? Mình ở đây để lắng nghe.',
  isUser: false,
  timestamp: new Date(),
};
  ...
  const handleSendMessage = useCallback(async (): Promise<void> => {
    ...
    try {
      ...
      const errorMessage: Message = {
        id: `msg_${Date.now() + 2}`,
        text: 'Xin lỗi, không thể gửi tin nhắn. Vui lòng thử lại.',
        isUser: false,
        timestamp: new Date(),
      };
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            ...
            <View style={styles.headerTextContainer}>
              <Text style={styles.botName}>Bạn Tâm giao</Text>
